...
function App() {
  ...
  const chatBubbleStyle = (isUser) => ({
    background: isUser 
      ? (darkMode ? "#4CAF50" : "#25D366") 
      : darkMode ? "#2a2a2a" : "#f4f4f4",
    color: isUser ? "#fff" : (darkMode ? "#f5f5f5" : "#000"),
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "Arial, sans-serif", ...themeStyles }}>
      ...
      <div style={{ width: "25%", borderRight: "1px solid #ddd", padding: "1rem", overflowY: "auto", display: "flex", flexDirection: "column", alignItems: "center" }}>
        {/* GPT Logo */}
        <img src="/ACADEMIC.png" alt="GPT Logo" style={{ width: "120px", marginBottom: "1rem" }} />
        {/* Description */}
        <div style={{ textAlign: "center", marginBottom: "1rem", padding: "0 0.5rem" }}>
          <p style={{ fontSize: "0.9rem", color: darkMode ? "#f5f5f5" : "#333", lineHeight: "1.4rem" }}>
            Your AI Study Buddy — Get summaries, simple explanations, and topic-focused answers. Learn smarter, faster, and easier with our education-powered "AcademicAI".
          </p>
        </div>
        {/* New Chat */}
        <button
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "6px",
              border: "none",
              background: darkMode ? "#4caf50" : "#333",
              color: "white",
              cursor: "pointer",
              fontSize: "0.8rem"
            }}
        ...
        <div style={{ flex: 1, overflowY: "auto", paddingRight: "0.5rem", display: "flex", flexDirection: "column" }}>
          {activeSession?.messages.map((chat, idx) => (
            <div key={idx} style={{ display: "flex", flexDirection: "column" }}>
              {/* User Message */}
              <div style={chatBubbleStyle(true)}>
                <strong>You:</strong> {chat.question}
              </div>
              {/* Bot Message with small GPT logo */}
              <div style={chatBubbleStyle(false)}>
                <img src="/agent.png" alt="GPT" style={{ width: "24px", height: "24px", marginRight: "8px", marginTop: "4px" }} />
                      ...
                      components={{
                        code({ node, inline, className, children, ...props }) {
                          ...
                          return !inline && match ? (
                            ...
                            <code style={{ background: "#eee", padding: "2px 4px", borderRadius: "4px" }} {...props}>
                              {children}
                            </code>
                          );
                        }
